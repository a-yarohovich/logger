...
class LitePrettyPrinter extends LogPrinter {
  static final levelColors = {
    Level.verbose: AnsiColor.fg(AnsiColor.grey(0.5)),
    Level.debug: AnsiColor.none(),
    Level.info: AnsiColor.fg(12),
  ...
  String _getLevelMarker(Level level) {
    switch (level) {
      case Level.info:
        return "<I";
      case Level.warning:
  ...
  List<String> _formatAndPrint(
    ...
    List<String> buffer = [];
    var color = _getLevelColor(level);
    buffer.add("${color(_getLevelMarker(level))} ${color(time)}  ${color(message)}\t:$stacktrace");
    return buffer;
  }
}
